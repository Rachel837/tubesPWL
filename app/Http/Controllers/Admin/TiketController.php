...
class TiketController extends Controller
{
    ...
    {
        return view('admin.events.tikets.create', compact('event'));
    }
    ...
    public function store(Request $request, Event $event)
    {
        ...
        return redirect()->route('admin.events.show', $event->idevent)
                         ->with('success', 'Tiket berhasil ditambahkan.');
    }

    public function edit(Event $event, Tiket $tiket)
    {
        return view('admin.events.tikets.edit', compact('event', 'tiket'));
    }

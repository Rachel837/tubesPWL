    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            ...
            <form action="{{ route('organizer.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="koordinator" value="{{ auth()->id() }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2" id="preview-container" style="display: none;">
                        <small class="text-muted">Pratinjau Banner:</small><br>
                        <img id="banner-preview" src="#" alt="Pratinjau" style="height: 100px; object-fit: cover;" class="rounded">
                    </div>
                </div>

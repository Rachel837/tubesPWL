...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('organizer.events.edit', $event->idevent) }}" class="btn btn-primary">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mb-4">
                    <span class="badge bg-info text-dark me-2">{{ $event->category->nama_kategori ?? 'Tidak ada kategori' }}</span>
                    @if($event->status == 'aktif')
                        <span class="badge bg-success">Aktif</span>
                    @elseif($event->status == 'tidak aktif')
            ...
            <div class="col-md-12 mt-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('organizer.events.tikets.create', $event->idevent) }}" class="btn btn-sm btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('organizer.events.tikets.edit', [$event->idevent, $tiket->idtiket]) }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i> Edit</a>
                                            <form action="{{ route('organizer.events.tikets.destroy', [$event->idevent, $tiket->idtiket]) }}" method="POST" onsubmit="return confirm('Hapus tiket ini?');">
                                                @csrf
                                                @method('DELETE')
